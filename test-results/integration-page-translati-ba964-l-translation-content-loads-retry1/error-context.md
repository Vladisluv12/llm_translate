...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e10]: Конволюционные сети используются для анализа визуальной имиджи.
    - generic [ref=e11]: Повторяющиеся сети обрабатывают временные последовательные данные.
```
